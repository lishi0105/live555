...
int readSocket(UsageEnvironment& env, int socket, unsigned char* buffer,
               ...
               struct sockaddr_storage&
                   fromAddress /*set only if we're a datagram socket*/);
...
_groupsockPriv* groupsockPriv(
    UsageEnvironment& env);  // allocates it if necessary
...
extern "C" u_int32_t
our_random32();  // because "our_random()" returns a 31-bit number
