...
class GroupEId {
public:
    GroupEId(struct sockaddr_storage const& groupAddr, portNumBits portNum,
             u_int8_t ttl);
    ...
    GroupEId();  // tmp default constructor, until "Groupsock" interface uses
                 // "sockaddr_storage"
...
private:
    struct sockaddr_storage
        fGroupAddress;  // also includes port number (in network byte order)
