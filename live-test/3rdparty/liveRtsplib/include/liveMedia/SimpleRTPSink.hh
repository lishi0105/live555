...
public:
    ...
    // other than "audio", set the RTP "M" bit on each outgoing packet iff it
    // contains the last (or only) fragment of a frame. Otherwise (i.e., if
    // "doNormalMBitRule" is False, or the medium is "audio"), leave the "M" bit
    // unset.
