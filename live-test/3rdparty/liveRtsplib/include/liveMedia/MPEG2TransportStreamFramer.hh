...
public:
    static MPEG2TransportStreamFramer* createNew(UsageEnvironment& env,
...
protected:
    MPEG2TransportStreamFramer(UsageEnvironment& env,
                               FramedSource* inputSource);
...
private:
    ...
    unsigned long
        fNumTSPacketsToStream;  // used iff "fLimitNumTSPacketsToStream" is True
