...
class MPEG2TransportFileServerMediaSubsession
    : public FileServerMediaSubsession {
public:
    static MPEG2TransportFileServerMediaSubsession* createNew(
        UsageEnvironment& env, char const* dataFileName,
...
private:  // redefined virtual functions
    // Note that because - to implement 'trick play' operations - we're
    // operating on more than just the input source, we reimplement some
    // functions that are already implemented in
    // "OnDemandServerMediaSubsession", rather than reimplementing
    // "seekStreamSource()" and "setStreamSourceScale()":
    ...
    // The virtual functions that are usually implemented by
...
// file). It is used only within the implementation of
// "MPEG2TransportFileServerMediaSubsession", but is included here, in case
// subclasses of "MPEG2TransportFileServerMediaSubsession" want to use it.
