...
public:
    ...
    // If "passwordIsMD5" is True, then "password" is actually the value
    // computed by md5(<username>:<realm>:<actual-password>)
...
private:
    ...
    void assign(char const* realm, char const* nonce, char const* username,
                char const* password, Boolean passwordIsMD5);
