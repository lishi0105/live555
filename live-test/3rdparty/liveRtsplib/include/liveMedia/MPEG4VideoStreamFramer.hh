...
public:
    static MPEG4VideoStreamFramer* createNew(UsageEnvironment& env,
    ...
    // Assigns the "profile_and_level_indication" number, and the 'config'
    // bytes. If this function is not called, then this data is only assigned
    // later, when it appears in the input stream.

protected:
    MPEG4VideoStreamFramer(UsageEnvironment& env, FramedSource* inputSource,
