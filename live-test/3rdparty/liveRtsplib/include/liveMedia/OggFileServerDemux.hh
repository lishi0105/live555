...
public:
    typedef void(onCreationFunc)(OggFileServerDemux* newDemux,
                                 void* clientData);
    ...
    // (to parse the Ogg 'Track' headers) before a new object can be
    ...
    // track number within the Ogg file. (You should not call this function more
    // than once with the same track number.)
