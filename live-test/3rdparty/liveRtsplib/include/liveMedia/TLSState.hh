...
public:
    ...
    void
    nullify();  // clear the state so that the destructor will have no effect
...
public:
    ...
    int connect(
        int socketNum);  // returns: <0 (error), 0 (pending), >0 (success)
...
public:
    ...
    void setCertificateAndPrivateKeyFileNames(char const* certFileName,
