...
public:
    static MPEG1or2FileServerDemux* createNew(UsageEnvironment& env,
                                              char const* fileName,
                                              Boolean reuseFirstSource);

    ServerMediaSubsession*
    newAudioServerMediaSubsession();  // MPEG-1 or 2 audio
    ...
    ServerMediaSubsession*
    newAC3AudioServerMediaSubsession();  // AC-3 audio (from VOB)
