...
public:
    static H264VideoRTPSource* createNew(
...
// stream). The value is returned as an array (length "numSPropRecords") of
// "SPropRecord"s. This array is dynamically allocated by this routine, and must
