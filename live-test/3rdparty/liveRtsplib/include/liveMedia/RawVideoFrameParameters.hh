...
// Parameters used for streaming (transmitting and receiving) raw video frames
// over RTP C++ header
...
public:
    RawVideoFrameParameters(unsigned width, unsigned height, unsigned depth,
                            char const* sampling);
...
public:
    ...
    u_int16_t
        scanLineIterationStep;  // usually 1, but 2 for sampling=="YCbCr-4:2:0"
};
