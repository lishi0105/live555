...
#define DV_SAVED_INITIAL_BLOCKS_SIZE \
    ((DV_NUM_BLOCKS_PER_SEQUENCE + 6 - 1) * DV_DIF_BLOCK_SIZE)
...
public:
    static DVVideoStreamFramer* createNew(
    ...
    // (e.g. a file), and the server that uses us does a seek-to-zero on the
    // source before reading from it.  (Our RTSP server implementation does
    // this.)
    char const* profileName();
    Boolean getFrameParameters(unsigned& frameSize /*bytes*/,
