...
typedef void MPEG1or2DemuxOnDeletionFunc(
    void* objectToNotify, class MPEG1or2Demux* demuxBeingDeleted);

class MPEG1or2Demux : public Medium {
public:
    static MPEG1or2Demux* createNew(
    ...
    void flushInput();  // should be called before any 'seek' on the underlying
                        // source
