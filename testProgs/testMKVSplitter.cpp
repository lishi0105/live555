...
// track (video, audio, subtitles), and outputs each track to a file. main
// program
...
void onMatroskaFileCreation(MatroskaFile* matroskaFile, void* /*clientData*/) {
    ...
    for (unsigned i = 0; i < 3; ++i) {
        ...
        // Create the file name from "mimeType" by replacing "/" with "-", and
        // adding the track number at the end:
        char* fileName =
            new char[strlen(mimeType) + 100 /*more than enough space*/];
