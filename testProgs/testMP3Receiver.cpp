...
// To stream using IPv6 multicast, rather than IPv4 multicast, uncomment the
// following:
...
int main(int argc, char** argv) {
    ...
    Groupsock rtcpGroupsock(*env, sessionAddress, sourceFilterAddress,
                            rtcpPort);
    ...
    if (sessionState.source == NULL) {
        *env
            << "Unable to create an ADU deinterleaving filter for the source\n";
        exit(1);
    }
