...
int main(int argc, char** argv) {
    ...
    char const* outputAddressStr =
        "239.255.43.43";  // this could also be unicast
                          // Note: You may change "outputAddressStr" to use a
                          // different multicast (or unicast address), but do
                          // *not* change it to use the same multicast address
                          // as "inputAddressStr".
