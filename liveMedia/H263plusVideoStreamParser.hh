...
#define ADDITIONAL_BYTES_NEEDED \
...
public:
    ...
    unsigned parse(
        u_int64_t& currentDuration);  // returns the size of the frame  that was
                                      // acquired, or 0 if none
...
private:
    ...
    void GetMaxBitrate(MaxBitrate_CTX* ctx, u_int32_t frameSize,
...
private:
    ...
    u_int64_t
        fcurrentPT;  // The current frame's presentation time in milli-seconds
};
