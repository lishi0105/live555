...
OggDemux* OggFile ::newDemux(OggDemuxOnDeletionFunc* onDeletionFunc,
                             void* objectToNotify) {
...
FramedSource* OggFile ::createSourceForStreaming(
    FramedSource* baseSource, u_int32_t trackNumber, unsigned& estBitrate,
...
RTPSink* OggFile ::createRTPSinkForTrackNumber(
    u_int32_t trackNumber, Groupsock* rtpGroupsock,
