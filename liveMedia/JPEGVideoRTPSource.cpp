...
JPEGVideoRTPSource* JPEGVideoRTPSource::createNew(
    ...
    unsigned rtpTimestampFrequency, unsigned defaultWidth,
...
static void createHuffmanHeader(unsigned char*& p,
                                unsigned char const* codelens, int ncodes,
                                unsigned char const* symbols, int nsymbols,
...
static void createJPEGHeader(unsigned char* buf, unsigned type, unsigned w,
                             unsigned h, unsigned char const* qtables,
...
Boolean JPEGVideoRTPSource ::processSpecialHeader(
  ...
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
    */
    ...
    unsigned Offset =
        (unsigned)((DWORD)headerStart[1] << 16 | (DWORD)headerStart[2] << 8 |
                   (DWORD)headerStart[3]);
        ...
        if (Q > 127) {
            ...
            */
            ...
            if (MBZ == 0) {
                ...
                unsigned Length =
                    (unsigned)((WORD)headerStart[resultSpecialHeaderSize + 2]
                                   << 8 |
