...
public:
    ...
    // (e.g., due to seeking within the source).  It causes any
    // still-unprocessed MP3 frame data within our queue to be discarded, so
    // that it does not erroneously get used by backpointers from the new MP3
    // frames.
