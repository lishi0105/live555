...
public:
    ...
    u_int16_t currentLineNumber()
        const;  // of the most recently-read/processed scan line
    u_int8_t currentLineFieldId()
        const;  // of the most recently-read/processed scan line (0 or 1)
    u_int16_t currentOffsetWithinLine()
        const;  // of the most recently-read/processed scan line
