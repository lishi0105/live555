...
// and needto be written by the programmer (depending on the features of the
// particulardevice). C++ header
...
public:
    ...
    // Note that this is defined here to be a static class variable, because
    // this code is intended to illustrate how to encapsulate a *single* device
    // - not a set of devices. You can, however, redefine this to be a
