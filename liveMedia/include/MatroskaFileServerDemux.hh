...
public:
    typedef void(onCreationFunc)(MatroskaFileServerDemux* newDemux,
                                 void* clientData);
    ...
    ServerMediaSubsession* newServerMediaSubsessionByTrackNumber(
        unsigned trackNumber);
    // As above, but creates a new "ServerMediaSubsession" object for a specific
    // track number within the Matroska file. (You should not call this function
    // more than once with the same track number.)
    ...
    FramedSource* newDemuxedTrack(unsigned clientSessionId,
                                  unsigned trackNumber);
...
private:
    ...
    static void onDemuxDeletion(void* clientData,
