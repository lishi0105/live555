...
public:
    static VorbisAudioRTPSource* createNew(UsageEnvironment& env,
                                           Groupsock* RTPgs,
...
void parseVorbisOrTheoraConfigStr(char const* configStr,
                                  ...
                                  u_int8_t*& commentHdr,
                                  unsigned& commentHdrSize, u_int8_t*& setupHdr,
...
// stream). Each of the "*Hdr" result arrays are dynamically allocated by this
// routine, and must be delete[]d by the caller.
