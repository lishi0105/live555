...
public:
    static uLawFromPCMAudioSource* createNew(UsageEnvironment& env,
...
public:
    static PCMFromuLawAudioSource* createNew(UsageEnvironment& env,
                                             FramedSource* inputSource);
...
public:
    static NetworkFromHostOrder16* createNew(UsageEnvironment& env,
                                             FramedSource* inputSource);
...
public:
    static HostFromNetworkOrder16* createNew(UsageEnvironment& env,
                                             FramedSource* inputSource);
...
public:
    static EndianSwap16* createNew(UsageEnvironment& env,
                                   FramedSource* inputSource);
...
public:
    static EndianSwap24* createNew(UsageEnvironment& env,
                                   FramedSource* inputSource);
