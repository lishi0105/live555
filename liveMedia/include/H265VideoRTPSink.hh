...
public:
    static H265VideoRTPSink* createNew(UsageEnvironment& env, Groupsock* RTPgs,
...
protected:
    H265VideoRTPSink(UsageEnvironment& env, Groupsock* RTPgs,
                     ...
                     unsigned vpsSize = 0, u_int8_t const* sps = NULL,
                     unsigned spsSize = 0, u_int8_t const* pps = NULL,
                     unsigned ppsSize = 0);
