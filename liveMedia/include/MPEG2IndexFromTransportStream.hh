...
public:
    static MPEG2IFrameIndexFromTransportStream* createNew(
...
private:
    Boolean fIsH264;  // True iff the video is H.264 (encapsulated in a
                      // Transport Stream)
    Boolean fIsH265;  // True iff the video is H.265 (encapsulated in a
                      // Transport Stream)
    ...
    // Note: We assume: 1 program per Transport Stream; 1 video stream per
    // program
