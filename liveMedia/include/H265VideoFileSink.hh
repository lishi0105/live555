...
public:
    static H265VideoFileSink* createNew(
        ...
        // (comma-separated Base64-encoded) representing VPS, SPS, and/or PPS
        // NAL-units to prepend to the output
        unsigned bufferSize = 100000, Boolean oneFilePerFrame = False);
    // See "FileSink.hh" for a description of these parameters.

protected:
    H265VideoFileSink(UsageEnvironment& env, FILE* fid, char const* sPropVPSStr,
