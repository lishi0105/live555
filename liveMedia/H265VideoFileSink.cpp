...
H265VideoFileSink ::H265VideoFileSink(UsageEnvironment& env, FILE* fid,
...
H265VideoFileSink* H265VideoFileSink::createNew(
    UsageEnvironment& env, char const* fileName, char const* sPropVPSStr,
