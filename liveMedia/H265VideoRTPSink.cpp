...
H265VideoRTPSink ::H265VideoRTPSink(UsageEnvironment& env, Groupsock* RTPgs,
    ...
    : H264or5VideoRTPSink(265, env, RTPgs, rtpPayloadFormat, vps, vpsSize, sps,
                          spsSize, pps, ppsSize) {}
...
H265VideoRTPSink* H265VideoRTPSink ::createNew(
...
H265VideoRTPSink* H265VideoRTPSink ::createNew(
    ...
    H265VideoRTPSink* result = new H265VideoRTPSink(
        env, RTPgs, rtpPayloadFormat, vps, vpsSize, sps, spsSize, pps, ppsSize);
