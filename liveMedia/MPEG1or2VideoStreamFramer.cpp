...
public:
    MPEG1or2VideoStreamParser(MPEG1or2VideoStreamFramer* usingSource,
                              FramedSource* inputSource, Boolean iFramesOnly,
                              double vshPeriod);
...
MPEG1or2VideoStreamParser ::MPEG1or2VideoStreamParser(
    MPEG1or2VideoStreamFramer* usingSource, FramedSource* inputSource,
...
unsigned MPEG1or2VideoStreamParser::parseSlice() {
    ...
    if (isSliceStartCode(next4Bytes)) {  // common case
        ...
        switch (next4Bytes) {
            ...
            default: {
                usingSource()->envir() << "MPEG1or2VideoStreamParser::"
                                          "parseSlice(): Saw unexpected code "
                                       << (void*)next4Bytes << "\n";
