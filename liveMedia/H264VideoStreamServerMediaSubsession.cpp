...
H264VideoStreamServerMediaSubsession::createNew(UsageEnvironment& env,
    ...
    return new H264VideoStreamServerMediaSubsession(env, fps, cb,
                                                    reuseFirstSource);
}
...
char const* H264VideoStreamServerMediaSubsession::getAuxSDPLine(
...
FramedSource* H264VideoStreamServerMediaSubsession::createNewStreamSource(
    ...
    return H264VideoStreamFramer::createNew(envir(), byteStreamSource);
}

RTPSink* H264VideoStreamServerMediaSubsession ::createNewRTPSink(
