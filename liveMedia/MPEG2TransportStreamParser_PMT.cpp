...
void MPEG2TransportStreamParser ::parsePMT(PIDState_PMT* pidState, Boolean pusi,
    ...
    while (numDescriptorBytes >=
        ...
        switch (descriptor_tag) {
            ...
            case 0x10: {
                ...
                fprintf(
                    stderr,
                    "\t\t\t\tsb_leak_rate: %d => %f Mbps; sb_size: %d bytes\n",
...
PIDState_PMT ::PIDState_PMT(MPEG2TransportStreamParser& parser, u_int16_t pid,
