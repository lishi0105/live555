...
private:
    ...
    void parseStartOfPage(u_int8_t& header_type_flag,
                          u_int32_t& bitstream_serial_number);

    Boolean validateHeader(OggTrack* track, u_int8_t const* p,
                           unsigned headerSize);
...
private:
    ...
    u_int8_t* fSavedPacket;  // used to temporarily save a copy of a 'packet'
                             // from a page
};
