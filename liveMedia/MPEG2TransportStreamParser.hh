...
protected:  // we're a virtual base class
    PIDState(MPEG2TransportStreamParser& parser, u_int16_t pid,
             PIDType pidType);
...
public:
    PIDState_PMT(MPEG2TransportStreamParser& parser, u_int16_t pid,
...
public:
    PIDState_STREAM(MPEG2TransportStreamParser& parser, u_int16_t pid,
                    u_int16_t programNumber, u_int8_t streamType);
...
public:
    StreamType(char const* description = "unknown",
...
public:
    ...
    static void continueParsing(void* clientData, unsigned char* ptr,
...
private:
    ...
    Boolean processDataBytes(u_int16_t PID, Boolean pusi,
    ...
    Boolean processStreamPacket(PIDState_STREAM* pidState, Boolean pusi,
                                unsigned numDataBytes);
