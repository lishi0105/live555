...
public:
    ...
    // "maxDelayTime" is in microseconds.  It allows a subclass to impose a
    // limit on how long "select()" can delay, in case it wants to also do
    // polling. 0 (the default value) means: There's no maximum; just look at
    // the delay queue
